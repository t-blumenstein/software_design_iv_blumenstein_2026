...
export class ProductService {
  ...
  private _productListSubject: BehaviorSubject<Product[]> = new BehaviorSubject<Product[]>(
    [] as Product[],
  );

  private _productSubject: BehaviorSubject<Product | null> = new BehaviorSubject<Product | null>(
    null,
  );

  public productList$: Observable<Product[]> = this._productListSubject.asObservable();

  public product$: Observable<Product | null> = this._productSubject.asObservable();
